...
def getWordScore(word, n):
    ...
    points = word_len * sum([SCRABBLE_LETTER_VALUES[letter] for letter in word])
...
def updateHand(hand, word):
    ...
    for letter in word:
        update_hand[letter] = update_hand.get(letter,0) - 1        
...
def calculateHandlen(hand):
    ...
    returns: integer
    """
    return sum([num for num in hand.itervalues() if num != 0])
